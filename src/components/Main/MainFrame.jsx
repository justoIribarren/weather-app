...
const MainFrame = ({ props, weather, hourly, dayState }) => {

	let date = useDate(weather.timezone, 0)

	return (
		<section className="main__frame">
			<div className="main__header">
				<h2> { `${props.name}, ${props.country}` } </h2>
				{ date && <div className="main__header">
					<h3> {
					`${date.day}, ${date.month} ${date.number}`
					} </h3>
			...
			{ weather && <MainInfo weather={weather} dayState={dayState}/> }
